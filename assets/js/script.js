document.addEventListener("DOMContentLoaded", () => {
  ...
  const waNumber = "524442850470";
  const waMessage = "¡Hola! Confirmo con mucha emoción mi asistencia al cumpleaños de Carlitos y Paulito";
...
const fechaEvento = new Date(2026, 5, 7, 15, 0, 0).getTime();
